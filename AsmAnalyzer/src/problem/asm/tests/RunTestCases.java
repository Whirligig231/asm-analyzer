...
public class RunTestCases {
	...
	public static void main(String[] args) {
		...
		//tester.writeTestOutputToFile(tc1, "testExpectedOutputs/test1.dot");
		tester.runTest(tc1);
		...
		//tester.writeTestOutputToFile(tc2, "testExpectedOutputs/test2.dot");
		tester.runTest(tc2);
		...
		//tester.writeTestOutputToFile(tc3, "testExpectedOutputs/test3.dot");
		tester.runTest(tc3);
